...
<form method="POST" action="{{ url('manage/settings') }}"> 
 ...
 <div class="form-group">
    <div class="row">
    <label for="slack" class="col-md-4 control-label">Slack Webhook URL</label> 
    <div class="col-md-8"><input id="slack" name="slack"  class="form-control" value="{{ $data['slack'] }}"  type="text"></div></div></div>
