...
@endif
 ...
 <hr>
  ...
  {{ $reply->render() }}
   ...
   <form class="ui reply form" method="POST" action="{{ url('ticket/'.$ticket->tid) }}">
   {{ csrf_field() }}
...
<div class="row">
  ...
  <div class="col-md-6"><a href="{{ url('ticket/close/'.$ticket->tid) }}" class="btn btn-block  btn-primary">    <i class="fa fa-close"></i>   Close </a>
</div>
</div>
